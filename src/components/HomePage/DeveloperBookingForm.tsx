...
const DeveloperBookingForm: React.FC = () => {
  ...
  return (
   <section id="developer-booking-form" className="py-16 relative">
      ...
      <Image src={homePageFormBg.src} alt="Form Background" width={400} height={400} className=' absolute left-96 -top-10' />
    <div className=" relative grid grid-cols-7 justify-between p-8  gap-4 min-h-[50vh] container">
        ...
        <h1 className="text-5xl font-bold mb-4">
            BOOK A <span className="text-orange-500">
