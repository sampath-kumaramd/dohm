      ...
      {isMenuOpen && (
        <div className="md:hidden fixed inset-0 bg-cream-dark z-50">
          ...
          />
            ...
            <Link href="/" className="text-charcoal hover:text-orange" onClick={toggleMenu}>
              <h6>Home</h6>
            </Link>
            <Link href="/about" className="text-charcoal hover:text-orange" onClick={toggleMenu}>
              <h6>About us</h6>
            </Link>
            <Link href="/projects" className="text-charcoal hover:text-orange" onClick={toggleMenu}>
              <h6>Projects</h6>
            </Link>
            <Link href="/services" className="text-charcoal hover:text-orange" onClick={toggleMenu}>
              <h6>Services</h6>
            </Link>
